...
- Python import uses the bundled Python AST parser to create editable visual blocks. Unsupported statements are represented by gray `Unknown Syntax` comment blocks, and parse failures leave the existing workspace unchanged.
...
- The custom project license terms were not changed.
...
| A-05–A-06             | Added Python AST-to-block conversion, explicit `Unknown Syntax` comments for unsupported statements, one grouped undo action, replacement confirmation, and rollback after parse or conversion failure.                                                                                                                                                                                                                                           |
...
2. Python import maps common assignments, expressions, calls, conditions, loops, imports, and control statements. Other valid statements become `Unknown Syntax` comments by design.
...
- whether to fund a complete Python-AST-to-block converter;
